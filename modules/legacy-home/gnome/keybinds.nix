...
let
  ...
  processBinds = binds: mapAttrs (name: value: toList value) (filterAttrs (name: value: value != null && value != "") binds);
        ...
        customBinds // {
          ...
          "org/gnome/settings-daemon/plugins/media-keys" =
            (processBinds cfg.media) // (
              if customBindNames == [ ] then { }
              else { custom-keybindings = customBindNames; }
            );
