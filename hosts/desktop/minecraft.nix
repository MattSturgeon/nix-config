    ...
    servers = {
      "quad" = {
        ...
        symlinks.mods = pkgs.linkFarm "mods" {
          ...
          "ferrite-core.jar" = pkgs.fetchurl {
          ...
          "simple-voice-chat.jar" = pkgs.fetchurl {
          ...
          "shulker-box-tooltip.jar" = pkgs.fetchurl {
